...
import (
	...
	fTypes "github.com/aximchain/axc-cosmos-sdk/x/paramHub/types"
...
func TestSCParamCheck(t *testing.T) {
	...
	testcases := []TestCase{
		...
		{cp: generatSCParamChange(&stake.Params{UnbondingTime: 24 * time.Hour, MaxValidators: 10, BondDenom: "AXC", MinSelfDelegation: 100e8, MinDelegationChange: 1e5, RewardDistributionBatchSize: 1000}, 0), expectError: false},
		{cp: generatSCParamChange(&stake.Params{UnbondingTime: 24 * time.Hour, MaxValidators: 10, BondDenom: "AXC1", MinSelfDelegation: 100e8, MinDelegationChange: 1e5, RewardDistributionBatchSize: 1000}, 0), expectError: true},
		{cp: generatSCParamChange(&stake.Params{UnbondingTime: 1 * time.Second, MaxValidators: 10, BondDenom: "AXC", MinSelfDelegation: 100e8, MinDelegationChange: 1e5, RewardDistributionBatchSize: 2000}, 0), expectError: true},
		{cp: generatSCParamChange(&stake.Params{UnbondingTime: 24 * time.Hour, MaxValidators: 0, BondDenom: "AXC", MinSelfDelegation: 100e8, MinDelegationChange: 1e5, RewardDistributionBatchSize: 3000}, 0), expectError: true},
		{cp: generatSCParamChange(&stake.Params{UnbondingTime: 24 * time.Hour, MaxValidators: 10, BondDenom: "AXC", MinSelfDelegation: 1e7, MinDelegationChange: 1e5, RewardDistributionBatchSize: 8000}, 0), expectError: true},
		{cp: generatSCParamChange(&stake.Params{UnbondingTime: 24 * time.Hour, MaxValidators: 10, BondDenom: "AXC", MinSelfDelegation: 100e8, MinDelegationChange: 1e5, RewardDistributionBatchSize: 10}, 0), expectError: true},
		{cp: generatSCParamChange(&stake.Params{UnbondingTime: 24 * time.Hour, MaxValidators: 10, BondDenom: "AXC", MinSelfDelegation: 100e8, MinDelegationChange: 1e5, RewardDistributionBatchSize: 5010}, 0), expectError: true},
